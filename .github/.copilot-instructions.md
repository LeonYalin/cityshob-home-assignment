...
2. Terminal 1: Backend server (`cd packages/backend && npm start`)
3. Terminal 2: Frontend server (`cd packages/frontend && npm start`)
4. Terminal 3: For running commands, API testing, git operations, etc.
